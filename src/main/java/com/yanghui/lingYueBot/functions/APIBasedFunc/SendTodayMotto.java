...
import com.yanghui.lingYueBot.utils.DateUtil;
...
public class SendTodayMotto {
    ...
    public static Motto getTodayMotto() {
        ...
        String dateline = response.getString("dateline");
        String tts = response.getString("tts");
        String content_en = response.getString("content");
        String content_cn = response.getString("note");
        ...
        String picture2 = response.getString("picture2");
        String picture3 = response.getString("picture3");
        String picture4 = response.getString("picture4");
        String fenxiang_img = response.getString("fenxiang_img");
        ...
        Logger.logDebug("PowerWord", "Get Motto >> " + result);
        return result;
    }

    private static String getTodayMotto_JSON() {

        Logger.logDebug("PowerWord", "Get Random Motto -> Run");

        String result = null;
        OkHttpClient client = new OkHttpClient();
        Request request;
        String URL = getRequestURL();
        Logger.logDebug("PowerWord", "Request URL >> " + URL);
        ...
        try {
            ...
            Logger.logDebug("PowerWord", "Request Response >> " + response);
